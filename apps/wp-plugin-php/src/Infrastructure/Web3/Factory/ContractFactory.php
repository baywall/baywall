...
class ContractFactory {
	 ...
	 * コントラクトのインスタンスを生成します。
	 */
	public function create( RpcUrl $rpc_url, array $abi, Address $address, string $default_block = 'latest' ): Contract {
		$provider = new HttpProvider( $rpc_url->value(), Config::BLOCKCHAIN_REQUEST_TIMEOUT );
