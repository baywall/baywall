...
class AppContractTableSchema extends MigratorBase {
	...
	protected function versions(): array {
		return array(
			array( '0.0.1', AppContractTableSchema_0_0_1::class ),
...
/** @internal */
class AppContractTableSchema_0_0_1 extends MigrationBase {
